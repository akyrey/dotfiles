...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
    url = "https://github.com/zbirenbaum/copilot-cmp"
  },
  ["copilot.lua"] = {
    config = { "\27LJ\2\nA\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\24akyrey.core.copilot\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/opt/copilot.lua",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'refactoring.nvim', 'Comment.nvim', 'package-info.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
