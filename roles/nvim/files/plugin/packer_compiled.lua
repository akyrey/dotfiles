...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-fugitive', 'gitsigns.nvim', 'vim-commentary', 'nvim-lspinstall', 'nvim-treesitter-context'}, { event = "BufRead *" }, _G.packer_plugins)]]
