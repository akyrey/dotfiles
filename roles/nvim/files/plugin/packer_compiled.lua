...
_G.packer_plugins = {
  ...
  ["material.vim"] = {
    after = { "nvim-colorizer.lua", "nvim-bufferline.lua", "lualine.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'neoformat', 'vim-fugitive', 'nvim-treesitter-context', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
