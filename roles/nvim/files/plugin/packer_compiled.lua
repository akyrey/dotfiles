...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'neoformat', 'nvim-treesitter', 'nvim-treesitter-context', 'vim-fugitive', 'nvim-lspinstall'}, { event = "BufRead *" }, _G.packer_plugins)]]
