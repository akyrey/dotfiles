...
_G.packer_plugins = {
  ...
  neoformat = {
    loaded = false,
    needs_bufread = false,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/opt/neoformat"
  },
  ["nvim-autopairs"] = {
  ...
  ["nvim-lspconfig"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig"
  },
  ["nvim-lspinstall"] = {
    after = { "nvim-lspconfig" },
    loaded = false,
    needs_bufread = false,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/start/vim-commentary"
  },
  ["vim-fugitive"] = {
    after = { "gv.vim" },
    loaded = false,
  ...
  ["vim-man"] = {
    loaded = true,
    path = "/home/akyrey/.local/share/nvim/site/pack/packer/start/vim-man"
  },
  ["vim-wakatime"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\nH\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\tinit akyrey.plugins.package-info\frequire\0", "config", "package-info.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspinstall', 'nvim-treesitter-context', 'nvim-treesitter', 'vim-fugitive', 'neoformat'}, { event = "BufRead *" }, _G.packer_plugins)]]
