...
M.focus_or_close = function()
  ...
  if view.win_open() then
    ...
    view.open()
    if package.loaded["bufferline.state"] and akyrey.builtin.nvimtree.side == "left" then
      -- require'bufferline.state'.set_offset(akyrey.builtin.nvimtree.width + 1, 'File Explorer')
      require("bufferline.state").set_offset(akyrey.builtin.nvimtree.width + 1, "")
    end
  end
end
--
