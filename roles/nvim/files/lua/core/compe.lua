...
M.setup = function()
  vim.g.vsnip_snippet_dir = akyrey.vsnip_dir
  ...
  compe.setup(akyrey.builtin.compe)
  ...
  keymap.load(akyrey.builtin.compe.keymap.values, akyrey.builtin.compe.keymap.opts)
