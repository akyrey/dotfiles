...
local ftplugin_dir = akyrey.lsp.templates_dir
...
function M.generate_ftplugin(server_name, dir)
  ...
  for _, filetype in ipairs(filetypes) do
    ...
    local setup_cmd = string.format([[require("akyrey.lsp.manager").setup(%q)]], server_name)
...
function M.generate_templates(servers_names)
  servers_names = servers_names or akyrey_lsp_utils.get_supported_servers()
